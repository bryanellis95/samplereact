...
import ServiceGalleryPop from './components/ServiceGalleryPop';
import BrandLogoSlider from '../components/BrandLogoSlider';
import Footer from '../components/Footer';
import MobileMenu from '../components/MobileMenu';
class ServiceDetailsLeftSidebarpop extends Component{
    render(){
        return(
            <div>
                {/* Navigation bar */}
                        ...
                        <div className="row">
                            ...
                            <div className="service-details">
                                ...
                                <div className="row">
                                    ...
                                    <h2>“Pop machine” sterilizer</h2>
                                    <p>“Pop machine” sterilizer request a quote today!</p>
...
export default ServiceDetailsLeftSidebarpop;