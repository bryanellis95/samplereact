                        ...
                        <div className="offcanvas-inner-content">
                            ...
                            <div className="offcanvas-widget-area">
                                ...
                                <div className="header-contact-info">
                                    ...
                                    <li><i className="ion-android-phone-portrait" /> <a href="tel:3179655901">3179655901</a></li>
                                    <li><i className="ion-android-mail" /> <a href="mailto:Sales@HoosierMCo.com">Sales@HoosierMCo.com</a></li>
                                    </ul>
                                </div>
                                </div>
