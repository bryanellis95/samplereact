            ...
            <div>
                ...
                <div className="container">
                    ...
                    <div className="col-lg-6 col-12 mb-30">
                        ...
                        <h3>Welcome to US-UVC</h3>
                        <h1>Over 60 Years of Experience designing and building equipment</h1>
                        {/* <h4>We are ready to build your dream home Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolorum, beatae.</h4> */}
                        <p>US-UVC is a US based company that has over 60 years experience designing and building equipment. This product line is our attempt to help the USA and all other countries battle the Covid-19 and other virus / bacteria that have invaded our daily life.</p>
                        <a href="services" className="ht-btn--default ht-btn--default--dark-hover section-space--top--20">Our Products</a>
                        </div>
                    </div>
                    </div>
                </div>
                ...
                <div className="container">
                    ...
                    <div className="col-sm-6 col-12 order-1 order-lg-2">
                        ...
                        <img src="assets/img/logo/kleen.jpg" alt="" />
                        </div>
                    </div>
                    ...
                    <div className="col-lg-6 col-12 order-3 order-lg-1">
                        ...
                        <h1><span>60</span>Years of Experience</h1>
                        <p>US-UVC is a US based company that has over 60 years experience designing and building equipment. This product line is our attempt to help the USA and all other countries battle the Covid-19 and other virus / bacteria that have invaded our daily life.</p>
                        </div>
                    </div>
