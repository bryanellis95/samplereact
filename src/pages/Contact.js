                        ...
                        <div className="contact-information">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <span className="text"><span>441 E South St Shelbyville, IN 46124</span></span>
                                </li>
                                <li>
                                    <span className="icon"><i className="ion-ios-telephone-outline" /></span>
                                    <span className="text"><a href="tel:3179655901">+3179655901</a></span>
                                </li>
                                <li>
                                    <span className="icon"><i className="ion-ios-email-outline" /></span>
                                    <span className="text"><a href="mailto:Sales@HoosierMCo.com">Sales@HoosierMCo.com</a></span>
                                </li>
                            </ul>
                        </div>
                        </div>
